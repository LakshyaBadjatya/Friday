...
.PHONY: install install-voice install-dashboard dashboard test lint fmt type run docker-build docker-up docker-down gate-0 gate-1 gate-2 gate-3 gate-4 gate-5 gate-6 gate-7
